...
const mockClients = [
  ...
  { id: 2, name: "Nguyễn Văn A", role: "Sales", description: "Plan Q3 campaign" },
  { id: 3, name: "Lê Thị B", role: "Developer", description: "Review tech roadmap" },
];
...
// Clear form state AFTER toast fades out
  setTimeout(() => {
    setSelectedClient(null);
    setSelectedTime(null);
    setDescription("");
